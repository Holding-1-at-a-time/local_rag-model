    ...
    for c in conversations:
        try:
            ...
            response = ollama.embeddings(
                model="nomic-embed-text", prompt=serialized_convo
            )
            ...
            print(f"Failed to add conversation to vector database: {e}")
...
def create_queries(prompt):
    ...
    query_convo = [
        ...
        {'role': 'user', 'content': 'Please generate a list of Python list of queries to search the embeddings database for any data that would be relevant and necessary to have access to in order to correctly respond to the user prompt.'},
        {'role': 'assistant', 'content': '["what is the users name?", "what is the users age?", "what is the users email?", "what is the users phone number?"]'},
        {'role': 'user', 'content': 'How can I utilize NextJs App Router in my multitenancy SaaS application I want to create?'},
        {'role': 'assistant', 'content': '["you can use NextJs app router to create a multitenancy SaaS application", "you can use NextJs app router to create a multitenancy SaaS application by using the routing system", "you can also possible to use NextJs app router to create a multitenancy SaaS application by using the routing system, for instance parallel routing, nest routing, or dynamic routing."]'},
...
def recall(prompt):
    ...
    convo.append({'role': 'user', 'content': f'MEMORIES: {embeddings} n\n\ USER PROMPT: {prompt}'})
